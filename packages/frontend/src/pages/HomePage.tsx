  ...
  const features = [
    {
      ...
      description:
        "Set up token streams that run automatically without any manual intervention.",
    },
    {
      icon: Shield,
      title: "Fully On-Chain",
      description:
        "No backends, no oracles, no external dependencies. Pure blockchain automation.",
    },
    {
      icon: Zap,
      title: "Instant Setup",
    ...
    },
    {
      ...
      description:
        "Perfect for payroll, vesting, subscriptions, and donations.",
    },
  ];
  ...
  const useCases = [
    {
      ...
      description:
        "DAOs and companies can stream salaries automatically per block, week, or month.",
    },
    {
      icon: Repeat,
      title: "Contributor Vesting",
      description:
        "Developers receive tokens gradually after grants or contributions.",
    },
    {
      icon: Clock,
      title: "Subscriptions",
      description:
        "Users pay small recurring fees to access on-chain services.",
    },
    {
      icon: Users,
      title: "Micro-donations",
      description:
        "Send small amounts regularly to support public goods and causes.",
    },
  ];
  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center py-16 sm:py-24">
          ...
          <p className="mt-6 text-xl text-gray-500 max-w-3xl mx-auto">
            AutoStream enables automatic, recurring token payments on Massa
            blockchain. No backends, no keepers, no external dependencies. Just
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold text-gray-900">Use Cases</h2>
            <p className="mt-4 text-xl text-gray-600">
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            ...
            <span className="block text-blue-200">
              Create your first stream today.
            </span>
          </h2>
